  ...
  <div class="card p-3 sm:p-6">
    <div class="mb-4 sm:mb-8">
      <h3 class="text-xl sm:text-2xl font-bold text-gray-900 mb-3 sm:mb-4 flex items-center">
        <i class="fas fa-graduation-cap text-blue-600 mr-2 sm:mr-3" />
        Claude Code 使用教程
      </h3>
    ...
    <!-- 系统选择标签 -->
    <div class="mb-4 sm:mb-8">
      <div class="flex flex-wrap gap-1 sm:gap-2 p-1 sm:p-2 bg-gray-100 rounded-xl">
        <button 
          v-for="system in tutorialSystems" 
          :key="system.key"
          :class="['flex-1 py-2 sm:py-3 px-3 sm:px-6 text-xs sm:text-sm font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-1 sm:gap-2', 
    ...
    >
      <!-- 第一步：安装 Node.js -->
      <div class="mb-4 sm:mb-6 sm:mb-10">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">1</span>
          安装 Node.js 环境
        </h4>
        <p class="text-gray-600 mb-4 sm:mb-4 sm:mb-6 text-sm sm:text-base">
          Claude Code 需要 Node.js 环境才能运行。
        </p>
              
        <div class="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-4 sm:p-6 border border-blue-100 mb-4 sm:mb-4 sm:mb-6">
          ...
          <div class="mb-3 sm:mb-4">
            ...
            <ol class="list-decimal list-inside text-gray-600 space-y-1 sm:space-y-2 ml-2 sm:ml-4 text-xs sm:text-sm">
              <li>打开浏览器访问 <code class="bg-gray-100 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">https://nodejs.org/</code></li>
              <li>点击 "LTS" 版本进行下载（推荐长期支持版本）</li>
              <li>下载完成后双击 <code class="bg-gray-100 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">.msi</code> 文件</li>
          ...
          <div class="mb-3 sm:mb-4">
            ...
            <p class="text-gray-600 mb-2 text-xs sm:text-sm text-xs sm:text-sm">
              如果你安装了 Chocolatey 或 Scoop，可以使用命令行安装：
            </p>
            <div class="bg-gray-900 text-green-400 p-3 sm:p-4 rounded-lg font-mono text-xs sm:text-sm overflow-x-auto">
              <div class="mb-2">
                # 使用 Chocolatey
              </div>
          ...
          <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4">
            <h6 class="font-medium text-sm sm:text-base text-blue-800 mb-2 text-sm sm:text-base">
              Windows 注意事项
            </h6>
            <ul class="text-blue-700 text-xs sm:text-xs sm:text-sm space-y-1">
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4">
          <h6 class="font-medium text-green-800 mb-2 text-sm sm:text-base">
            验证安装是否成功
          </h6>
          <p class="text-green-700 text-xs sm:text-sm mb-2 sm:mb-3">
          ...
          <p class="text-green-700 text-xs sm:text-sm mt-2">
            如果显示版本号，说明安装成功了！
          </p>
        </div>
      </div>
      ...
      <div class="mb-4 sm:mb-6 sm:mb-10">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-green-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">2</span>
          安装 Git Bash
        </h4>
        <p class="text-gray-600 mb-4 sm:mb-4 sm:mb-6 text-sm sm:text-base">
        ...
        <div class="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 sm:p-6 border border-green-100 mb-4 sm:mb-6">
          <h5 class="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3 flex items-center">
            <i class="fab fa-git-alt text-green-600 mr-2" />
            下载并安装 Git for Windows
          </h5>
          <ol class="list-decimal list-inside text-gray-600 space-y-1 sm:space-y-2 ml-2 sm:ml-4 text-xs sm:text-sm mb-4">
            <li>访问 <code class="bg-gray-100 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">https://git-scm.com/downloads/win</code></li>
            <li>点击 "Download for Windows" 下载安装包</li>
            <li>运行下载的 <code class="bg-gray-100 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">.exe</code> 安装文件</li>
            <li>在安装过程中保持默认设置，直接点击 "Next" 完成安装</li>
          </ol>
          <div class="bg-green-50 border border-green-200 rounded-lg p-3 sm:p-4">
            <h6 class="font-medium text-sm sm:text-base text-green-800 mb-2">
              安装完成后
            </h6>
      ...
      <div class="mb-4 sm:mb-6 sm:mb-10">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-purple-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">3</span>
          安装 Claude Code
        </h4>
              
        <div class="bg-gradient-to-r from-purple-50 to-pink-50 rounded-xl p-4 sm:p-6 border border-purple-100 mb-4 sm:mb-6">
          <h5 class="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3 flex items-center">
          ...
          <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-3 sm:p-4 mt-4">
            <h6 class="font-medium text-sm sm:text-base text-yellow-800 mb-2">
              重要提醒
            </h6>
            <ul class="text-yellow-700 text-xs sm:text-sm space-y-1">
      ...
      <div class="mb-6 sm:mb-10">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-orange-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">4</span>
          设置环境变量
        </h4>
              
        <div class="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-xl p-4 sm:p-6 border border-orange-100 mb-4 sm:mb-6">
          <h5 class="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3 flex items-center">
          ...
          <div class="space-y-4">
            ...
            <div class="bg-white rounded-lg p-3 sm:p-4 border border-orange-200">
              ...
              <ol class="text-gray-600 text-xs sm:text-sm space-y-1 list-decimal list-inside">
                ...
                <div class="text-gray-300">
{
  "env": {
    ...
    "ANTHROPIC_AUTH_TOKEN": "你的API密钥"
        ...
        <!-- 验证环境变量设置 -->
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-3 sm:p-4 mt-6">
      ...
      <div class="mb-6 sm:mb-8">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-yellow-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">5</span>
          开始使用 Claude Code
        </h4>
        <div class="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl p-4 sm:p-6 border border-yellow-100">
          <p class="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
      ...
      <div class="mb-8">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <i class="fas fa-wrench text-red-600 mr-2 sm:mr-3" />
          Windows 常见问题解决
        </h4>
        <div class="space-y-4">
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            <summary class="p-3 sm:p-4 cursor-pointer font-medium text-gray-800 hover:bg-gray-100 text-sm sm:text-base">
              安装时提示 "permission denied" 错误
            </summary>
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              <p class="mb-2">
                这通常是权限问题，尝试以下解决方法：
              </p>
              <ul class="list-disc list-inside space-y-1 text-sm">
                <li>以管理员身份运行 PowerShell</li>
                <li>或者配置 npm 使用用户目录：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">npm config set prefix %APPDATA%\npm</code></li>
              </ul>
            </div>
          </details>
          ...
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1 text-sm">
                ...
                <li>验证设置：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">echo $env:ANTHROPIC_BASE_URL</code></li>
              </ul>
            </div>
          </details>
        </div>
    ...
    >
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div class="bg-gradient-to-r from-gray-50 to-slate-50 rounded-xl p-4 sm:p-6 border border-gray-200 mb-4 sm:mb-6">
          <h5 class="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3 flex items-center">
          ...
          <div class="mb-4">
            ...
            <ol class="list-decimal list-inside text-gray-600 space-y-1 sm:space-y-2 ml-2 sm:ml-4 text-xs sm:text-sm">
              <li>访问 <code class="bg-gray-100 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">https://nodejs.org/</code></li>
              <li>下载适合 macOS 的 LTS 版本</li>
              <li>打开下载的 <code class="bg-gray-100 px-1 sm:px-2 py-1 rounded text-xs sm:text-sm">.pkg</code> 文件</li>
              <li>按照安装程序指引完成安装</li>
            </ol>
          </div>
          <div class="bg-gray-50 border border-gray-200 rounded-lg p-3 sm:p-4">
            ...
            <ul class="text-gray-700 text-xs sm:text-sm space-y-1">
              <li>• 如果遇到权限问题，可能需要使用 <code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">sudo</code></li>
      ...
      <div class="mb-6 sm:mb-10">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-orange-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">3</span>
          设置环境变量
        </h4>
                ...
                <div class="text-gray-300">
{
  "env": {
    ...
    "ANTHROPIC_AUTH_TOKEN": "你的API密钥"
      ...
      <div class="mb-8">
        <h4 class="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
          <span class="w-6 h-6 sm:w-8 sm:h-8 bg-yellow-500 text-white rounded-full flex items-center justify-center text-xs sm:text-sm font-bold mr-2 sm:mr-3">4</span>
          开始使用 Claude Code
        </h4>
        <div class="bg-gradient-to-r from-yellow-50 to-amber-50 rounded-xl p-4 sm:p-6 border border-yellow-100">
          <p class="text-gray-700 mb-3 sm:mb-4 text-sm sm:text-base">
        ...
        <div class="space-y-4">
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1 text-sm">
                <li>使用 sudo 安装：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">sudo npm install -g @anthropic-ai/claude-code</code></li>
                <li>或者配置 npm 使用用户目录：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">npm config set prefix ~/.npm-global</code></li>
              </ul>
            </div>
          </details>
          ...
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1 text-sm">
                ...
                <li>点击"仍要打开"或"允许"</li>
                <li>或者在 Terminal 中运行：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">sudo spctl --master-disable</code></li>
              </ul>
            </div>
          </details>
          ...
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1 text-sm">
                ...
                <li>重新启动 Terminal</li>
                <li>验证设置：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">echo $ANTHROPIC_BASE_URL</code></li>
              </ul>
            </div>
          </details>
        </div>
    ...
    >
      ...
      <div class="mb-6 sm:mb-10">
        ...
        <div class="bg-gradient-to-r from-orange-50 to-red-50 rounded-xl p-4 sm:p-6 border border-orange-100 mb-4 sm:mb-6">
          <h5 class="text-base sm:text-lg font-semibold text-gray-800 mb-2 sm:mb-3 flex items-center">
          ...
          <div class="bg-orange-50 border border-orange-200 rounded-lg p-3 sm:p-4">
            <h6 class="font-medium text-sm sm:text-base text-orange-800 mb-2">
              Linux 注意事项
            </h6>
            <ul class="text-orange-700 text-xs sm:text-sm space-y-1">
                ...
                <div class="text-gray-300">
{
  "env": {
          ...
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1 text-sm">
                <li>使用 sudo 安装：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">sudo npm install -g @anthropic-ai/claude-code</code></li>
                <li>或者配置 npm 使用用户目录：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">npm config set prefix ~/.npm-global</code></li>
                <li>然后添加到 PATH：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">export PATH=~/.npm-global/bin:$PATH</code></li>
              </ul>
            </div>
          </details>
          ...
          <details class="bg-gray-50 rounded-lg border border-gray-200">
            ...
            <div class="px-3 sm:px-4 pb-3 sm:pb-4 text-gray-600">
              ...
              <ul class="list-disc list-inside space-y-1 text-sm">
                ...
                <li>重新启动终端或运行 <code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">source ~/.bashrc</code></li>
                <li>验证设置：<code class="bg-gray-200 px-1 rounded text-xs sm:text-sm">echo $ANTHROPIC_BASE_URL</code></li>
              </ul>
            </div>
          </details>
    ...
    <!-- 结尾 -->
    <div class="bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl p-4 sm:p-6 text-center">
      <h5 class="text-lg sm:text-xl font-semibold mb-2">
        🎉 恭喜你！
      </h5>
